...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, MainFragment.OnFragmentInteractionListener, ListPharmacie.OnFragmentInteractionListener {
    DrawerLayout drawer;
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmentTransaction.replace(R.id.content_fragment,listPharmacie);
            fragmentTransaction.commit();
            Toast.makeText(getApplicationContext(), "test",Toast.LENGTH_SHORT).show();
...
//        transaction.replace(R.id.list_pharmacie, fragment);
